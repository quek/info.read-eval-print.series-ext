...
(assert (equal '("a" "b" "c") (collect (scan-split "/" "a/b/c"))))
(assert (equal '("") (collect (scan-split "/" ""))))
(assert (equal '("" "") (collect (scan-split "/" "/"))))
(assert (equal '("" "a") (collect (scan-split "/" "/a"))))
(assert (equal '("" "a" "") (collect (scan-split "/" "/a/"))))
(assert (equal '("" "" "a" "" "") (collect (scan-split "/" "//a//"))))
(assert (equal '("a" "b" "cc" "d") (collect (scan-split "\\s+" "a b   cc
d"))))
